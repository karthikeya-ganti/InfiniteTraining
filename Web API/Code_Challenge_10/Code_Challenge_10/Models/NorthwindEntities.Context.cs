...
namespace Code_Challenge_10.Models
{
    ...
    public partial class NorthwindEntities : DbContext
    {
        ...
        public virtual ObjectResult<sp_GetCustomersByCountry_Result> sp_GetCustomersByCountry(string country)
        {
            var countryParameter = country != null ?
                new ObjectParameter("country", country) :
                new ObjectParameter("country", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_GetCustomersByCountry_Result>("sp_GetCustomersByCountry", countryParameter);
        }
    }
}
